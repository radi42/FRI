...
int
GenerateNetworks (struct TrieNode *Table, int Count)
{
  if (Table == NULL)
    return -ERR_NOTCREAT;
...
*/
  ...
  printf
    ("done.\nTime: %ld sec %ld usec, hits: %d, ratio: %f, avg lookup: %f usec, table size: %ld\n",
