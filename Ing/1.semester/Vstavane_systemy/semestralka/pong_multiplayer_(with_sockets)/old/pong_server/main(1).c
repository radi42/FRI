...
typedef struct
{
    int player1x, player1y, ballx, bally;
    int message;
} Message;
...
int main(int argc, char *argv[])
{
    ...
    pong.window_width = 700;
    pong.window_height = 503;
...
//	printf("%d\n", strcmp(message, start));
    ...
    while(!done)
    {
        ...
        printf("%d;%d;%d;%d || sizeof(msg) = %lu || msg = %d\n", msg.player1x, msg.player1y, msg.ballx, msg.bally, sizeof(msg), msg.message);
//        printf("%d;%d;%d;%d || sizeof(msg) = %lu\n", msg.player1x, msg.player1y, msg.ballx, msg.bally, sizeof(msg));
