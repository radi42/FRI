...
void init(DynZoz *zoz)
{
    ...
    zoz->pole = calloc(zoz->kapacita, sizeof(double));  // v C sa void smernik z calloc nemusi pretypovavat, v C++ sa ale musi
}
...
//void print(DynZoz * const zoz)  // to iste ako nasledujuce: citat odzadu: zoz je konstantny smernik na DynZoz
void print(const DynZoz *zoz)  // citat odzadu: zoz je smernik na DynZoz
{
