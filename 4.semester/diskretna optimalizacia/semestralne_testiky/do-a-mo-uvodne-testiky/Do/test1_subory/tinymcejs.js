...
function moodleFileBrowser (field_name, url, type, win) {
    ...
    switch(type) {
        ...
        case 'file':
        case 'media':
            cmsURL = 'https://vzdelavanie.uniza.sk/moodle/lib/editor/tinymce/link.php?id=0';
            width = 480;
            height = 400;
            break;
        case 'image':
            cmsURL = 'https://vzdelavanie.uniza.sk/moodle/lib/editor/tinymce/insert_image.php?id=0';
            width = 736;
            height = 430;
            break;
    }
