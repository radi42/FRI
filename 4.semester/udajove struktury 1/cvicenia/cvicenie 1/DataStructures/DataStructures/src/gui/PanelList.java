...
public class PanelList extends javax.swing.JPanel {
    ...
    private void printList() {      
        boolean print = false;
        try {
            print = aList.size() < 100000 || Routines.confirmDialog("List contains " + aList.size() + " elements,\ndo you want to print it?", "List too large!");
        }
        catch (EList ex){
        }
        ...
        for (Object person : aList)
            dlm.addElement(person);
        

        listElements.setModel(dlm);
    }
    ...
    private void btnTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTestActionPerformed
        try {                        
            ...
            if (iterations != -1) {
                ...
                panelOperations.log("Number od add operations: " + countAdd + " average time: " + decFormat.format(timeAdd/(double)countAdd) + PanelOperations.UNITS);
                panelOperations.log("Number od insert operations: " + countInsert + " average time: " + decFormat.format(timeInsert/(double)countInsert) + PanelOperations.UNITS);
                panelOperations.log("Number od delete operations: " + countDelete + " average time: " + decFormat.format(timeDelete/(double)countDelete) + PanelOperations.UNITS);
            }
            else {
