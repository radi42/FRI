...
/*
	...
	fgets(buffer, 255, stdin); 
        ...
        printf("%s\n", blank);
        printf("Pocet znakov: ");
        int blankLen = strlen(blank);
        printf("%d\n", blankLen);

        char prikaz[11];
        if(strcmp(blank, strcpy(prikaz, "insert")) == 0 ||
                strcmp(blank, strcpy(prikaz, "delete")) == 0 ||
                strcmp(blank, strcpy(prikaz, "update")) == 0 ||
                strcmp(blank, strcpy(prikaz, "select")) == 0){
