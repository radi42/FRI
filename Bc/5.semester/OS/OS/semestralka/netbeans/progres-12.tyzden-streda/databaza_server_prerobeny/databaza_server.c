...
int main(int argc, char *argv[])
{
	...
	cli_len = sizeof(cli_addr);
        ...
        do{
            ...
            for ( i = 0; i < pocet; i++ )
            {
                arr[i] = (char*) calloc(1024, sizeof(char));    //alokujem pole o takom pocte prvkov, kolko je argumentov, kde kazdy prvok moze mat 1023 znakov
            }
