...
/**
 * Trieda KostraNajlacnejsia
 * 
 * @author Andy
 */
public class KostraNajlacnejsia {
    private ArrayList<Vrchol> vrcholy;
    private ArrayList<Hrana> hrany;
    private ArrayList<Hrana> postupnost;

    /**
     * Konstruktor pre Najlacnejsiu kostru
     * @throws FileNotFoundException 
     */
    public KostraNajlacnejsia() throws FileNotFoundException {
        ...
        komponentVrchola();
        naplnHrany();
        usporiadajHranyPodlaCenyOdNajmensej();
        testVypis();
        najdiKostru();
        vypisKostruLacna();
    }
    ...
    /**
     * Krok 1 - pokracovanie
     * usporiadaj hrany od najmensej po najvacsiu
     */
    private void usporiadajHranyPodlaCenyOdNajmensej() {
        Collections.sort(hrany, new PorovnavacHranOdNajmensej() );
    }
    ...
    private void vypisKostruLacna() {
        int cenaKostry = 0;
        System.out.println("=====================================");
        System.out.println("Hrany najlacnejsej kostry grafu: ");
        ...
        System.out.println("Celkova cena najlacnejsej kostry je " + cenaKostry);
    }
}