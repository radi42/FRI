...
public class Main {
    ...
    private static ArrayList<ITelka> nakupnyKosik = new ArrayList<ITelka>();
    ...
    private static void vykonajAkciu(String index) throws FileNotFoundException, IOException{
        switch(index){
            ...
            case "7":
                ...
                break;
            case "8":
//                msgBox(obchodik.vypisTxtZoznam() );
                obchodik.citajDataZoznam();
                System.out.println("otvoril som zoznam zo suboru");
                break;
            case "0":
                msgBox("Dovidenia");
                break;
    ...
    private static void kupitTV() {
        ...
        try{
            ...
            msgBox("Kupili ste si takyto televizor\n"
                    ...
                    + "\n"
                    + "Polozka bola pridana do nakupneho kosika");
            }
            nakupnyKosik.add(obchodik.getObchod().get(index -1) );
...
//        }
//        
//        obchodik.getObchod().add(new TelkaPlazma(1000, 120, true, true) );
//        obchodik.getObchod().add(new TelkaCrt(100, 30, false, false) );
//        obchodik.getObchod().add(new TelkaLcd(400, 95, true, false) );
