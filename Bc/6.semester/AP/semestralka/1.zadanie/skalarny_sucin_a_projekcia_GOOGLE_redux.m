...
vektorChyb(1) = energiaRozdielovehoVektora4
vektorPriemernychChyb(1) = priemernaChyba4
...
vektorChyb(2) = energiaRozdielovehoVektora5
vektorPriemernychChyb(2) = priemernaChyba5
...
vektorChyb(3) = energiaRozdielovehoVektora6
vektorPriemernychChyb(3) = priemernaChyba6
...
vektorChyb(4) = energiaRozdielovehoVektora8
vektorPriemernychChyb(4) = priemernaChyba8
...
vektorChyb(5) = energiaRozdielovehoVektora9
vektorPriemernychChyb(5) = priemernaChyba9
...
vektorChyb(6) = energiaRozdielovehoVektora7
vektorPriemernychChyb(6) = priemernaChybaTakmerOptimalna

vektorChyb
vektorPriemernychChyb
rozdielOprotiMinimalnejPriemernejChybe = vektorPriemernychChyb - min(vektorPriemernychChyb);
rozdielOprotiMinimalnejPriemernejChybe


%plot(t, f, '-')
%plot(t, f, t, fProjekciaParabolouTriParametre, '-.')
%plot(t, f, t, fProjekciaParabolouTriParametre, t, fProjekciaPolynomomTretiehoStupnaStyriParametre, '-.')
%plot(t, f, t, fProjekciaParabolouTriParametre, t, fProjekciaPolynomomTretiehoStupnaStyriParametre, t, fProjekciaPolynomomStvrtehoStupnaPatParametrov, '-.')
%plot(t, f, t, fProjekciaParabolouTriParametre, t, fProjekciaPolynomomTretiehoStupnaStyriParametre, t, fProjekciaPolynomomStvrtehoStupnaPatParametrov, t, fProjekciaPolynomomPiatehoStupna, '-.')
%plot(t, f, t, fProjekciaParabolouTriParametre, t, fProjekciaPolynomomTretiehoStupnaStyriParametre, t, fProjekciaPolynomomStvrtehoStupnaPatParametrov, t, fProjekciaPolynomomPiatehoStupna, t, fProjekciaPolynomomSiestehoStupna, '-.')
