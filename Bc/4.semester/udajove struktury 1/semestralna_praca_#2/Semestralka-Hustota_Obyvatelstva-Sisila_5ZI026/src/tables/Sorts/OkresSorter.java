 ...
 */
public class OkresSorter<Okres> extends ElementSorter<Okres>{
    ...
    public void sort(ISortableTable paTable, KeyComparer paComparer) {
        try {
            ...
            System.out.println("Triedenie okresov sa pokazilo");
        }
    }
     ...
     */
    @Override
    public void sortElements(ISortableTable<Object, Okres> paTable, KeyComparer<Okres> paComparer) throws ETable {
