...
public abstract class Main
{
     ...
     * @param pllst datovy typ Pesnicka - odovzdava Playlist
     */
    ...
    /**
     * usporaduva skladby podla interpreta abecedne podla triedy
     * KomparatorInterpretov
     */
    private static void usporiadajPiesneInterpret() {
        //metoda funguje ked je atribut playlist v triede Playlist default,
        //public alebo protected
        //Collections.sort(pllst.playlist, new KomparatorInterpretov());
        
        //Collections.sort(pllst, usporiadajPiesneInterpret() );
        pllst.usporiadajPiesneInterpret();
        vypisPlaylist(pllst);
    }
